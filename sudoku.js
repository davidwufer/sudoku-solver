...
(function($opal) {
  ...
  $opal.add_stubs(['$[]', '$new_board', '$private', '$new']);
  ;
  ;
  ;
  return (function($base, $super) {
    ...
    return (def.$new_board = function() {
      ...
      return ($a = ($b = (($c = $scope.Array) == null ? $opal.cm('Array') : $c)).$new, $a._p = (TMP_1 = function(){var self = TMP_1._s || this, $a, $b, TMP_2, $c;

      return ($a = ($b = (($c = $scope.Array) == null ? $opal.cm('Array') : $c)).$new, $a._p = (TMP_2 = function(){var self = TMP_2._s || this;

        return "-"}, TMP_2._s = self, TMP_2), $a).call($b, 9)}, TMP_1._s = self, TMP_1), $a).call($b, 9);
    }, nil) && 'new_board';
  })(self, null);
})(Opal);
