...
(function($opal) {
  ...
  $opal.add_stubs(['$attr_reader', '$new', '$[]', '$set', '$create_board', '$*', '$board_rows', '$!', '$legitimate_move?', '$raise', '$[]=', '$join', '$all?', '$spots_all_filled?', '$rows_all_distinct?', '$columns_all_distinct?', '$quadrants_all_distinct?', '$private', '$solved?', '$==', '$count', '$uniq', '$transpose', '$each_slice', '$flatten', '$map', '$split', '$scan', '$to_proc', '$size', '$possible_values', '$delete_if', '$include?', '$first']);
  ;
  (function($base, $super) {
    function $Solver(){};
  ...
  (function($base, $super) {
    ...
    var self = $InvalidMoveError = $klass($base, $super, 'InvalidMoveError', $InvalidMoveError);

    var def = self._proto, $scope = self._scope;

    return nil;
  })(self, (($a = $scope.ArgumentError) == null ? $opal.cm('ArgumentError') : $a));
  (function($base, $super) {
    function $Board(){};
    ...
    def.$initialize = function(options) {
      ...
      return self.board_rows = self.$create_board(((($a = options['$[]']("board_string")) !== false && $a !== nil) ? $a : "-"['$*'](81)));
    };

    def.$get = function(row, col) {
      var self = this;

      return self.$board_rows()['$[]'](row)['$[]'](col);
    };

    def.$set = function(row, col, piece, check_legitimacy) {
      var $a, $b, self = this;

      if (check_legitimacy == null) {
      ...
      return self.$board_rows()['$[]'](row)['$[]='](col, piece);
    };

    def.$to_s = function() {
      var self = this;

      return self.$board_rows().$join();
    };
    ...
    def['$spots_all_filled?'] = function() {
      ...
      return ($a = ($b = self.$board_rows())['$all?'], $a._p = (TMP_1 = function(row){var self = TMP_1._s || this, $a, $b, TMP_2;
if (row == null) row = nil;
      return ($a = ($b = row)['$all?'], $a._p = (TMP_2 = function(col){var self = TMP_2._s || this;
if (col == null) col = nil;
        return col['$solved?']()}, TMP_2._s = self, TMP_2), $a).call($b)}, TMP_1._s = self, TMP_1), $a).call($b);
    };

    def['$rows_all_distinct?'] = function() {
      var $a, $b, TMP_3, self = this;

      return ($a = ($b = self.$board_rows())['$all?'], $a._p = (TMP_3 = function(row){var self = TMP_3._s || this;
if (row == null) row = nil;
      return row.$uniq().$count()['$=='](9)}, TMP_3._s = self, TMP_3), $a).call($b);
    };

    def['$columns_all_distinct?'] = function() {
      var $a, $b, TMP_4, self = this;

      return ($a = ($b = self.$board_rows().$transpose())['$all?'], $a._p = (TMP_4 = function(col){var self = TMP_4._s || this;
if (col == null) col = nil;
      return col.$uniq().$count()['$=='](9)}, TMP_4._s = self, TMP_4), $a).call($b);
    };

    def['$quadrants_all_distinct?'] = function() {try {

      var $a, $b, TMP_5, self = this;

      ($a = ($b = self.$board_rows()).$each_slice, $a._p = (TMP_5 = function(rows){var self = TMP_5._s || this, $a, $b, TMP_6;
if (rows == null) rows = nil;
      return ($a = ($b = rows.$transpose()).$each_slice, $a._p = (TMP_6 = function(quadrant){var self = TMP_6._s || this, $a;
if (quadrant == null) quadrant = nil;
        if ((($a = quadrant.$flatten().$uniq().$count()['$=='](9)['$!']()) !== nil && (!$a._isBoolean || $a == true))) {
            $opal.$return(false)
            } else {
            return nil
          }}, TMP_6._s = self, TMP_6), $a).call($b, 3)}, TMP_5._s = self, TMP_5), $a).call($b, 3);
      return true;
    ...
    return (def.$create_board = function(board_string) {
      ...
      return ($a = ($b = board_string.$scan(/.{9}/)).$map, $a._p = (TMP_7 = function(row){var self = TMP_7._s || this, $a, $b, TMP_8;
if (row == null) row = nil;
      return ($a = ($b = row.$split("")).$map, $a._p = (TMP_8 = function(cell_string){var self = TMP_8._s || this, $a;
if (cell_string == null) cell_string = nil;
        if (cell_string['$==']("-")) {
            return (($a = $scope.BoardCell) == null ? $opal.cm('BoardCell') : $a).$new()
            } else {
            return (($a = $scope.BoardCell) == null ? $opal.cm('BoardCell') : $a).$new($hash2(["possible_values"], {"possible_values": [cell_string]}))
          }}, TMP_8._s = self, TMP_8), $a).call($b)}, TMP_7._s = self, TMP_7), $a).call($b);
    }, nil) && 'create_board';
  })(self, null);
  return (function($base, $super) {
    function $BoardCell(){};
    var self = $BoardCell = $klass($base, $super, 'BoardCell', $BoardCell);

    var def = self._proto, $scope = self._scope;

    self.$attr_reader("possible_values");
    ...
    def.$initialize = function(options) {
      ...
      return self.possible_values = ((($a = options['$[]']("possible_values")) !== false && $a !== nil) ? $a : ($b = ($c = ($range(0, 9, false))).$map, $b._p = "to_s".$to_proc(), $b).call($c));
    };
    ...
    def.$eliminate_possible_values = function(values) {
      ...
      return ($a = ($b = self.$possible_values()).$delete_if, $a._p = (TMP_9 = function(v){var self = TMP_9._s || this;
if (v == null) v = nil;
      return values['$include?'](v)}, TMP_9._s = self, TMP_9), $a).call($b);
    };

    return (def.$to_s = function() {
      var $a, self = this;

      if ((($a = self['$solved?']()) !== nil && (!$a._isBoolean || $a == true))) {
        } else {
        return "-"
      };
      return self.$possible_values().$first();
    }, nil) && 'to_s';
  })(self, null);
})(Opal);

//# sourceMappingURL=/__opal_source_maps__/board.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var $a, $b, TMP_1, $c, self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $hash2 = $opal.hash2;

  $opal.add_stubs(['$ready?', '$find', '$on', '$value', '$first', '$solve', '$new', '$text', '$to_s']);
  ;
  ;
  ;
  ;
  return ($a = ($b = (($c = $scope.Document) == null ? $opal.cm('Document') : $c))['$ready?'], $a._p = (TMP_1 = function(){var self = TMP_1._s || this, $a, $b, TMP_2, button = nil;

  button = (($a = $scope.Element) == null ? $opal.cm('Element') : $a).$find("button");
    return ($a = ($b = button).$on, $a._p = (TMP_2 = function(){var self = TMP_2._s || this, $a, input_board = nil, solved_board = nil;
...
//# sourceMappingURL=/__opal_source_maps__/sudoku.js.map
;
