...
(function($opal) {
  ...
  $opal.add_stubs(['$attr_reader', '$new', '$[]', '$set', '$create_board', '$*', '$board_internal', '$[]=', '$join', '$private', '$map', '$split', '$scan']);
  ;
  (function($base, $super) {
    function $Solver(){};
  ...
  return (function($base, $super) {
    ...
    return (def.$create_board = function(board_string) {
      ...
      return ($a = ($b = board_string.$scan(/.{9}/)).$map, $a._p = (TMP_1 = function(row){var self = TMP_1._s || this;
if (row == null) row = nil;
      return row.$split("")}, TMP_1._s = self, TMP_1), $a).call($b);
    }, nil) && 'create_board';
  })(self, null);
})(Opal);

//# sourceMappingURL=/__opal_source_maps__/logic.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
