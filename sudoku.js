...
(function($opal) {
  ...
  (function($base, $super) {
    ...
    return (def.$create_board = function(board_string) {
      ...
      return ($a = ($b = board_string.$scan(/.{9}/)).$map, $a._p = (TMP_1 = function(row){var self = TMP_1._s || this, $a, $b, TMP_2;
if (row == null) row = nil;
      return ($a = ($b = row.$split("")).$map, $a._p = (TMP_2 = function(cell_string){var self = TMP_2._s || this, $a;
if (cell_string == null) cell_string = nil;
        if (cell_string['$==']("-")) {
            return (($a = $scope.BoardCell) == null ? $opal.cm('BoardCell') : $a).$new()
            } else {
            return (($a = $scope.BoardCell) == null ? $opal.cm('BoardCell') : $a).$new(self.$options()['$[]']($hash2(["possible_values"], {"possible_values": cell_string})))
